...
[![Build Status](https://img.shields.io/github/actions/workflow/status/canstralian/MCP-Kali-Server/ci.yml?branch=main)](https://github.com/canstralian/MCP-Kali-Server/actions) 
